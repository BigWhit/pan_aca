...
coco_root_dir = './data/cocotext/'
coco_train_data_dir = coco_root_dir + 'train2014/'
coco_train_gt_dir = coco_root_dir + 'bbox/'
coco_test_data_dir = coco_root_dir+'Challenge2_Test_Task12_Images/'
coco_test_gt_dir = coco_root_dir+'Challenge3_Test_Task1_GT/'
...
class PAN_COCO(data.Dataset):
    def __init__(self,
        ...
        if split == 'train':
            data_dirs = [coco_train_data_dir]
            gt_dirs = [coco_train_gt_dir]
        elif split == 'test':
            data_dirs = [coco_test_data_dir]
            gt_dirs = [coco_test_gt_dir]
        else:
...
#########train
        for data_dir, gt_dir in zip(data_dirs, gt_dirs):
            gt_names = [gt_name for gt_name in mmcv.utils.scandir(gt_dir, '.txt')]

            img_paths = []
            gt_paths = []
            for idx, gt_name in enumerate(gt_names):
