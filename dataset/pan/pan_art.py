...
ctw_root_dir = './data/ArT2019/'
ctw_train_data_dir = ctw_root_dir + 'train_images/'
ctw_train_gt_dir = ctw_root_dir + 'train_gt/'
ctw_test_data_dir = ctw_root_dir + 'test_part1_images/'
ctw_test_gt_dir = ctw_root_dir
...
def get_ann(img, gt_path):
    ...
    for line in lines:
        ...
        bbox = [np.int(gt[i]) for i in range(len(gt))]
        bbox = np.asarray(bbox) / ([w * 1.0, h * 1.0] * (len(gt)//2))
